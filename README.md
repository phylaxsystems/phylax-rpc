...
This package is the headless logic for that flow (the spike that motivated it: ENG-3585 → ENG-3593 → **ENG-3594**).
...
`attemptSwitch` returns `outcome: 'unsupported'` (and `manualFallback: true`) for everything not on the allowlist — your cue to render the manual-add modal (ENG-3595).
...
> Currently a **dummy** placeholder — it renders the dialog chrome but not the per-wallet step content yet (ENG-3595).
