...
export interface ManualAddModalProps {
   ...
   * opens, every three seconds while visible, and when the window regains focus. The Rainbow
   * and Zerion guides skip it because their active RPC cannot be detected reliably.
